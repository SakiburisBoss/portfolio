          ...
          ? projects.map((project, index) => (
              ...
              >
                <div className="relative w-full h-full">
                  ...
                  {/* Action Buttons - Outside of Link to prevent nested anchors */}
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      {project.liveDemoUrl && (
                        <a
                          ...
                          className="inline-flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 rounded-lg shadow-lg backdrop-blur-sm transition-all duration-200 hover:scale-105 hover:shadow-xl group/btn"
                        >
                      ...
                      {project.codes && (
                        <a
                          ...
                          rel="noopener noreferrer"
                          onClick={(e) => e.stopPropagation()}
                          className="inline-flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-gray-700 to-gray-900 hover:from-gray-800 hover:to-black rounded-lg shadow-lg backdrop-blur-sm transition-all duration-200 hover:scale-105 hover:shadow-xl group/btn"
                        >
